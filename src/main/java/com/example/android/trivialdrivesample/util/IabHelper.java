...
public abstract class IabHelper {
    ...
    public void startSetup(final OnIabSetupFinishedListener listener) {
        ...
        if (!packageExists(mContext, ANDROID_INSTALLER) && !packageExists(mContext, GOOGLE_INSTALLER)) {
...
//            return false;
        ...
        serviceIntent.setPackage(ANDROID_INSTALLER);
        List<ResolveInfo> intentServices = mContext.getPackageManager().queryIntentServices(serviceIntent, 0);
//        if (intentServices != null && !intentServices.isEmpty()) {
        if (intentServices != null && !intentServices.isEmpty()) {
            // service available to handle that Intent
            logDebug("binding service vending");
            ...
            if (listener != null) {
                ...
                logDebug("no listener available");
            }
        }
    }
    ...
    private static boolean packageExists(Context context, String packageName) {
        try {
            ...
            Log.d(packageName, " package was not found.");
            return false;
        }
    }
    ...
    public void launchPurchaseFlow(Activity act, String sku, int requestCode, OnIabPurchaseFinishedListener listener, Intent data)
            throws IabAsyncInProgressException {
        launchPurchaseFlow(act, sku, requestCode, listener, "", data);
    }

    public void launchPurchaseFlow(Activity act, String sku, int requestCode,
                                   OnIabPurchaseFinishedListener listener, String extraData, Intent data)
            throws IabAsyncInProgressException {
        launchPurchaseFlow(act, sku, ITEM_TYPE_INAPP, null, requestCode, listener, extraData, data);
    }

    public void launchSubscriptionPurchaseFlow(Activity act, String sku, int requestCode,
                                               OnIabPurchaseFinishedListener listener, Intent data) throws IabAsyncInProgressException {
        launchSubscriptionPurchaseFlow(act, sku, requestCode, listener, "", data);
    }

    public void launchSubscriptionPurchaseFlow(Activity act, String sku, int requestCode,
                                               OnIabPurchaseFinishedListener listener, String extraData, Intent data)
            throws IabAsyncInProgressException {
        launchPurchaseFlow(act, sku, ITEM_TYPE_SUBS, null, requestCode, listener, extraData, data);
    }
    ...
    public void launchPurchaseFlow(Activity act, String sku, String itemType, List<String> oldSkus,
                                   int requestCode, OnIabPurchaseFinishedListener listener, String extraData, Intent data)
            throws IabAsyncInProgressException {
        checkNotDisposed();
        ...
        if (itemType.equals(ITEM_TYPE_SUBS) && !mSubscriptionsSupported) {
            ...
            flagEndAsync();
            if (listener != null) listener.onIabPurchaseFinished(r, null, data);
            return;
        }
        ...
        try {
            ...
            if (response != BILLING_RESPONSE_RESULT_OK) {
                ...
                if (listener != null) listener.onIabPurchaseFinished(result, null, data);
                return;
            }
    ...
    public boolean handleActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (data == null) {
            ...
            if (mPurchaseListener != null)
                mPurchaseListener.onIabPurchaseFinished(result, null, data);
            return true;
        }
        ...
        if (resultCode == Activity.RESULT_OK && responseCode == BILLING_RESPONSE_RESULT_OK) {
            ...
            try {
                ...
                if (!Security.verifyPurchase(mSignatureBase64, purchaseData, dataSignature)) {
                    ...
                    if (mPurchaseListener != null)
                        mPurchaseListener.onIabPurchaseFinished(result, purchase, data);
                    return true;
                }
//                try {
//                    ((BaseActivity) originalContext).getBaseActivityHelper().postPurchase(data.getExtras(), null);
//                } catch (TwibexException e) {
//                    e.printStackTrace();
//                }
            ...
            if (mPurchaseListener != null) {
                mPurchaseListener.onIabPurchaseFinished(new IabResult(BILLING_RESPONSE_RESULT_OK, "Success"), purchase, data);
            }
     ...
     *
     * @param querySkuDetails if true, SKU details (buyPrice, description, etc) will be queried as well
    ...
    public Inventory queryInventory(boolean querySkuDetails, List<String> moreItemSkus,
        ...
        try {
            ...
            Log.i(TAG, "querySkuDetails: " + querySkuDetails);
            if (querySkuDetails) {
            ...
            if (mSubscriptionsSupported) {
                ...
                if (querySkuDetails) {
                    Log.i(TAG, "subs querySkuDetails");
        ...
        do {
            ...
            for (int i = 0; i < purchaseDataList.size(); ++i) {
                ...
                try {
                    ...
                    if (Security.verifyPurchase(mSignatureBase64, purchaseData, signature) || true) {
...
//                    ((BaseActivity) originalContext).getBaseActivityHelper().logException(e);
                    logException(e);
                }
            }
    ...
    public abstract void logException(IllegalArgumentException e);
...
//                Looper.loop();
    ...
    public String getSignature(String sku) {
        return null;
    }
    ...
    public interface OnIabPurchaseFinishedListener {
         ...
         */
        void onIabPurchaseFinished(IabResult result, Purchase info, Intent originalIntent);
    }
